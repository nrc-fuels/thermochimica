...
subroutine ParseCSDataBlockGibbs(i,j,iCounterGibbsEqn)
    ...
    LOOP_GibbsEquations: do m = 1, nGibbsEqSpecies(j)
        ...
        read (1,*, IOSTAT = INFO) dGibbsCoeffSpeciesTemp(1:5,iCounterGibbsEqn)
        read (1,*, IOSTAT = INFO) dGibbsCoeffSpeciesTemp(6:7,iCounterGibbsEqn)
